...
#   positions.hair = [(239 + randint(-2, 2), 281 + randint(-2, 2)), (229 + randint(-2, 2), 254 + randint(-2, 2)), (224 + randint(-2, 2), 258 + randint(-2, 2)), (227 + randint(-2, 2), 246 + randint(-2, 2)), (219 + randint(-2, 2), 230 + randint(-2, 2)), (213 + randint(-2, 2), 207 + randint(-2, 2)), (212 + randint(-2, 2), 194 + randint(-2, 2)), (215 + randint(-2, 2), 181 + randint(-2, 2)), (210 + randint(-2, 2), 185 + randint(-2, 2)), (210 + randint(-2, 2), 173 + randint(-2, 2)), (212 + randint(-2, 2), 160 + randint(-2, 2)), (207 + randint(-2, 2), 171 + randint(-2, 2)), (208 + randint(-2, 2), 186 + randint(-2, 2)), (203 + randint(-2, 2), 174 + randint(-2, 2)), (204 + randint(-2, 2), 165 + randint(-2, 2)), (208 + randint(-2, 2), 154 + randint(-2, 2)), (207 + randint(-2, 2), 146 + randint(-2, 2)), (203 + randint(-2, 2), 136 + randint(-2, 2)), (203 + randint(-2, 2), 125 + randint(-2, 2)), (206 + randint(-2, 2), 112 + randint(-2, 2)), (200 + randint(-2, 2), 112 + randint(-2, 2)), (192 + randint(-2, 2), 105 + randint(-2, 2)), (198 + randint(-2, 2), 106 + randint(-2, 2)), (209 + randint(-2, 2), 106 + randint(-2, 2)), (203 + randint(-2, 2), 102 + randint(-2, 2)), (199 + randint(-2, 2), 94 + randint(-2, 2)), (202 + randint(-2, 2), 86 + randint(-2, 2)), (203 + randint(-2, 2), 89 + randint(-2, 2)), (204 + randint(-2, 2), 94 + randint(-2, 2)), (212 + randint(-2, 2), 95 + randint(-2, 2)), (208 + randint(-2, 2), 91 + randint(-2, 2)), (209 + randint(-2, 2), 87 + randint(-2, 2)), (211 + randint(-2, 2), 91 + randint(-2, 2)), (218 + randint(-2, 2), 91 + randint(-2, 2)), (222 + randint(-2, 2), 87 + randint(-2, 2)), (226 + randint(-2, 2), 77 + randint(-2, 2)), (221 + randint(-2, 2), 75 + randint(-2, 2)), (216 + randint(-2, 2), 70 + randint(-2, 2)), (214 + randint(-2, 2), 61 + randint(-2, 2)), (204 + randint(-2, 2), 68 + randint(-2, 2)), (213 + randint(-2, 2), 53 + randint(-2, 2)), (197 + randint(-2, 2), 74 + randint(-2, 2)), (207 + randint(-2, 2), 53 + randint(-2, 2)), (227 + randint(-2, 2), 33 + randint(-2, 2)), (236 + randint(-2, 2), 27 + randint(-2, 2)), (248 + randint(-2, 2), 22 + randint(-2, 2)), (259 + randint(-2, 2), 18 + randint(-2, 2)), (272 + randint(-2, 2), 15 + randint(-2, 2)), (283 + randint(-2, 2), 15 + randint(-2, 2)), (298 + randint(-2, 2), 14 + randint(-2, 2)), (308 + randint(-2, 2), 16 + randint(-2, 2)), (318 + randint(-2, 2), 18 + randint(-2, 2)), (330 + randint(-2, 2), 21 + randint(-2, 2)), (337 + randint(-2, 2), 21 + randint(-2, 2)), (336 + randint(-2, 2), 17 + randint(-2, 2)), (336 + randint(-2, 2), 9 + randint(-2, 2)), (339 + randint(-2, 2), 15 + randint(-2, 2)), (347 + randint(-2, 2), 14 + randint(-2, 2)), (357 + randint(-2, 2), 11 + randint(-2, 2)), (368 + randint(-2, 2), 8 + randint(-2, 2)), (382 + randint(-2, 2), 10 + randint(-2, 2)), (379 + randint(-2, 2), 6 + randint(-2, 2)), (398 + randint(-2, 2), 17 + randint(-2, 2)), (390 + randint(-2, 2), 3 + randint(-2, 2)), (409 + randint(-2, 2), 22 + randint(-2, 2)), (410 + randint(-2, 2), 15 + randint(-2, 2)), (415 + randint(-2, 2), 8 + randint(-2, 2)), (422 + randint(-2, 2), 8 + randint(-2, 2)), (416 + randint(-2, 2), 13 + randint(-2, 2)), (416 + randint(-2, 2), 21 + randint(-2, 2)), (418 + randint(-2, 2), 29 + randint(-2, 2)), (428 + randint(-2, 2), 35 + randint(-2, 2)), (434 + randint(-2, 2), 43 + randint(-2, 2)), (441 + randint(-2, 2), 53 + randint(-2, 2)), (445 + randint(-2, 2), 63 + randint(-2, 2)), (444 + randint(-2, 2), 71 + randint(-2, 2)), (458 + randint(-2, 2), 67 + randint(-2, 2)), (468 + randint(-2, 2), 69 + randint(-2, 2)), (478 + randint(-2, 2), 81 + randint(-2, 2)), (473 + randint(-2, 2), 75 + randint(-2, 2)), (463 + randint(-2, 2), 72 + randint(-2, 2)), (454 + randint(-2, 2), 73 + randint(-2, 2)), (451 + randint(-2, 2), 78 + randint(-2, 2)), (460 + randint(-2, 2), 74 + randint(-2, 2)), (457 + randint(-2, 2), 82 + randint(-2, 2)), (469 + randint(-2, 2), 86 + randint(-2, 2)), (462 + randint(-2, 2), 87 + randint(-2, 2)), (483 + randint(-2, 2), 95 + randint(-2, 2)), (480 + randint(-2, 2), 98 + randint(-2, 2)), (493 + randint(-2, 2), 99 + randint(-2, 2)), (505 + randint(-2, 2), 105 + randint(-2, 2)), (513 + randint(-2, 2), 113 + randint(-2, 2)), (518 + randint(-2, 2), 120 + randint(-2, 2)), (521 + randint(-2, 2), 137 + randint(-2, 2)), (518 + randint(-2, 2), 131 + randint(-2, 2)), (513 + randint(-2, 2), 123 + randint(-2, 2)), (518 + randint(-2, 2), 139 + randint(-2, 2)), (520 + randint(-2, 2), 150 + randint(-2, 2)), (519 + randint(-2, 2), 164 + randint(-2, 2)), (520 + randint(-2, 2), 177 + randint(-2, 2)), (523 + randint(-2, 2), 183 + randint(-2, 2)), (529 + randint(-2, 2), 190 + randint(-2, 2)), (522 + randint(-2, 2), 190 + randint(-2, 2)), (516 + randint(-2, 2), 208 + randint(-2, 2)), (512 + randint(-2, 2), 225 + randint(-2, 2)), (516 + randint(-2, 2), 231 + randint(-2, 2)), (521 + randint(-2, 2), 236 + randint(-2, 2)), (523 + randint(-2, 2), 245 + randint(-2, 2)), (523 + randint(-2, 2), 258 + randint(-2, 2)), (520 + randint(-2, 2), 274 + randint(-2, 2)), (514 + randint(-2, 2), 290 + randint(-2, 2)), (506 + randint(-2, 2), 306 + randint(-2, 2)), (504 + randint(-2, 2), 316 + randint(-2, 2)), (503 + randint(-2, 2), 325 + randint(-2, 2)), (500 + randint(-2, 2), 336 + randint(-2, 2)), (494 + randint(-2, 2), 350 + randint(-2, 2)), (490 + randint(-2, 2), 346 + randint(-2, 2)), (487 + randint(-2, 2), 350 + randint(-2, 2)), (483 + randint(-2, 2), 355 + randint(-2, 2))]
...
def files():
    positions()  #255,255,255(r,g,b)
    draw(positions.outer_face, co = (randint(213,217), randint(172,179), randint(130,139)), mode = 0)
    draw(positions.inner_face, co = (randint(218,222), randint(127,130), randint(102,110)), mode = 0)
